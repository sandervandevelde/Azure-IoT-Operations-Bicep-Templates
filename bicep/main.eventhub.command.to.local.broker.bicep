...
param dataflowName string = 'azure-eventhub-command-2-local-mqtt-command'
...
resource eventhubDataflowEndpoint 'Microsoft.IoTOperations/instances/dataflowEndpoints@2024-11-01' existing = {
  parent: aioInstance
  name: 'azure-eventhub-dataflow-endpoint'
}
    ...
    operations: [
      {
        ...
        sourceSettings: {
          ...
          endpointRef: eventhubDataflowEndpoint.name
      ...
      }
      {
        ...
        destinationSettings: {
          ...
          dataDestination: 'local/eventhub/command'
        }
      }
    ]
  }
